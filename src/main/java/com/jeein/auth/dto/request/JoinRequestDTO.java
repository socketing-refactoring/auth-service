package com.jeein.auth.dto.request;
...
public class JoinRequestDTO {
    ...
    @Size(max = 50, message = "이메일은 50자 이하로 입력해 주세요.")
    ...
    public static JoinRequestDTO of(String email, String name, String nickname, String password) {
        return JoinRequestDTO.builder().email(email).name(name).nickname(nickname).password(password).build();
    }
}
