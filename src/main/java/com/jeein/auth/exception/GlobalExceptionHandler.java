...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<CommonResponseDTO<Object>> handleFeignException(FeignException e) {
        CommonResponseDTO<Object> response = CommonResponseDTO.error(ErrorCode.FEIGN_CLIENT_ERROR);
    ...
    protected ResponseEntity<CommonResponseDTO<Object>> handleMemberFeignException(MemberFeignException e) {
        CommonResponseDTO<Object> response = CommonResponseDTO.error(ErrorCode.FEIGN_CLIENT_ERROR);
        log.info(e.getMessage());
        log.info("member feign exception");
        return new ResponseEntity<CommonResponseDTO<Object>>(response, e.getStatus());
    }
    ...
    protected ResponseEntity<CommonResponseDTO<Object>> handleException(Exception e) {
        CommonResponseDTO<Object> response = CommonResponseDTO.error(ErrorCode.INTERNAL_SERVER_ERROR);
        log.info(e.getMessage());
