...
public class CommonSnippet {
    ...
    public static final FieldDescriptor DATA_NICKNAME = fieldWithPath("data.nickname").description("회원 닉네임");
    public static final FieldDescriptor DATA_EMAIL = fieldWithPath("data.email").description("회원 이메일");

    public static final FieldDescriptor SUCCESS_DATA_ARRAY =
                    fieldWithPath("data").optional().description("응답 값");
    public static final FieldDescriptor DATA_ARRAY_ID = fieldWithPath("data.id").description("회원 ID");
    public static final FieldDescriptor DATA_ARRAY_NAME = fieldWithPath("data.name").description("회원 이름");
    public static final FieldDescriptor DATA_ARRAY_NICKNAME =
                    fieldWithPath("data.nickname").description("회원 닉네임");
    public static final FieldDescriptor DATA_ARRAY_EMAIL = fieldWithPath("data.email").description("회원 이메일");
